...
class Topics extends MY_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $body = $this->tec->body_censor($this->input->post('body', false));
            ...
            if ($this->Member) {
                ...
                if ($this->Settings->review_option == 1 || ($this->Settings->review_option == 2 && $user_publiched_number < 5) || ($this->Settings->review_option == 3 && $user_publiched_number < 10)) {
                    $data['status'] = null;
                }
            }
    ...
    public function add_post($topic_id)
    {
    ...
    public function get_child_categories($category_id)
    {
        ...
        $data       = ['categories' => $categories, 'fields' => $fields];
