...
</script><small class="text-center">Advertisement (' . lang('ad_footer') . ')</small>' : htmlspecialchars(base64_decode($_POST['ad_footer_code']), ENT_QUOTES),
                'footer_code' => DEMO ? '<script>
$(document).ready(function() {
    console.info("Footer code is being added.");
});
</script>' : htmlspecialchars(base64_decode($_POST['footer_code']), ENT_QUOTES),
    ...
    public function api_keys($api_id = null)
    {
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = ['site_name'   => DEMO ? 'SimpleForum' : $this->input->post('site_name'),
