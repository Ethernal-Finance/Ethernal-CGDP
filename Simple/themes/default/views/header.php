        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php
                        ...
                        <?php
                            ...
                            <li><a href="<?= site_url('login'); ?>"><?= lang('login'); ?></a></li>
                            <?php if ($Settings->mode != 2 && $Settings->registration) { ?>
                ...
                <div class="hidden-xs hidden-sm" style="position:relative;">
                    <?= form_open('search', 'class="header-search pull-right" method="GET" autocomplete="off"'); ?>
                    <input type="text" name="query" id="forum-search" placeholder="<?= lang('search'); ?>" class="font300" value="<?= $this->input->get('query') ? $this->input->get('query') : ''; ?>"/>
                    <button type="submit" class="search-filter"><i class="fa fa-search"></i></button>
                    <div id="search-suggestions" class="list-group" style="position:absolute;top:100%;right:0;left:0;display:none;z-index:99;"></div>
                    <?= form_close(); ?>
                </div>
            </div>
        </div>
