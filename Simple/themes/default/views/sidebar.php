...
<aside class="col-sm-4">
    ...
    <div class="ad ad-sidebar text-center"><?= htmlspecialchars_decode($Settings->ad_sidebar_code, ENT_QUOTES); ?></div>
    <?php } ?>
    ...
    <?php if (!empty($online_users)) { ?>
        <div class="add-box fade-icon">
            <h2>
                <a <?= $this->Settings->member_page ? 'href="' . site_url('members?online=1') . '"' : 'class="disabled"'; ?>>
                    <?= $online_users . ' ' . ($online_users > 1 ? lang('members') : lang('member')) . ' ' . lang('online'); ?>
    ...
    <div class="ad ad-sidebar-2 mt text-center"><?= htmlspecialchars_decode($Settings->ad_sidebar2_code, ENT_QUOTES); ?></div>
    <?php } ?>
</aside>
