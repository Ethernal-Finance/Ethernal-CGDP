...
<div class="col-sm-8">
    <div class="page-box">
        <?php
        $de = ['0' => $this->lang->line('disable'), '1' => $this->lang->line('enable')];
        ?>

        <h3><i class="fa fa-puzzle-piece"></i> <?= lang('ad_settings'); ?></h3>
        <p><?= lang('update_info'); ?></p>

        <?php $attrib = ['data-toggle' => 'validator', 'role' => 'form', 'id' => 'ad_settings'];
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_textarea('ad_thread_code', htmlspecialchars_decode($Settings->ad_thread_code, ENT_QUOTES), 'class="form-control" id="ad_thread_code"'); ?>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_textarea('ad_sidebar_code', htmlspecialchars_decode($Settings->ad_sidebar_code, ENT_QUOTES), 'class="form-control" id="ad_sidebar_code"'); ?>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_textarea('ad_sidebar2_code', htmlspecialchars_decode($Settings->ad_sidebar2_code, ENT_QUOTES), 'class="form-control" id="ad_sidebar2_code"'); ?>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_textarea('ad_footer_code', htmlspecialchars_decode($Settings->ad_footer_code, ENT_QUOTES), 'class="form-control" id="ad_footer_code"'); ?>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo form_textarea('footer_code', htmlspecialchars_decode($Settings->footer_code, ENT_QUOTES), 'class="form-control" id="footer_code"'); ?>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
