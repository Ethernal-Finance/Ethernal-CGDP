...
<div class="col-sm-8">
    <div class="page-box">
        <?php
        $ps = ['0' => $this->lang->line('disable'), '1' => $this->lang->line('enable')];
        ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <?= lang('mode', 'mode'); ?>
                    <?php
                    $eopt = [0 => lang('public'), 1 => lang('private'), 2 => lang('maintainence')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <?= lang('style', 'style'); ?>
                    <?php
                    $sopt = ['white' => 'White', 'orange' => 'Orange', 'blue' => 'Blue', 'red' => 'Red', 'green' => 'Green', 'purple' => 'Purple', 'dark_grey' => 'Dark Grey', 'grey' => 'Grey', 'yellow' => 'Yellow'];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    $sopt = ['right' => lang('right'), 'left' => lang('left')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $eopt = ['redactor' => 'Trumbowyg (HTML)', 'simpledme' => 'SimpleMDE (Markdown)', 'sceditor' => 'SCEditor (BBCODE)'];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $copt = [0 => lang('disable'), 1 => lang('login'), 2 => lang('forum')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $ropt = [0 => lang('disable'), 1 => lang('all'), 2 => lang('first_five'), 3 => lang('first_ten')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $nopt = [0 => lang('disable'), 1 => lang('admins'), 2 => lang('admins_n_mods')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $sopt = [0 => lang('newest'), 1 => lang('oldest'), 2 => lang('higher_votes'), 3 => lang('lower_votes'), 4 => lang('newest_reply'), 5 => lang('oldest_reply'), 6 => lang('most_views'), 7 => lang('least_views')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <?= lang('voting', 'voting'); ?>
                    <?php
                    $vopt = [0 => lang('disable'), 1 => lang('thumbs_rating'), 2 => lang('stars_rating')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <?= lang('api_keys', 'apis'); ?>
                    <?php
                    $api_opts = [0 => lang('disable'), 1 => lang('enable_admins'), 2 => lang('enable_all')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $yn = [0 => lang('disable'), 1 => lang('enable')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $foopt = [0 => lang('disable'), 1 => lang('hide_thread'), 2 => lang('show_thread')];
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php
                    $mpopt = [0 => lang('disable'), 1 => lang('enable')];
            ...
            <div class="col-md-12">
                <div class="well well-sm">
                    ...
                    <p class="text-info">
                        <code><?= site_url('social_auth/login/XXXXXX'); ?></code>
                        <code><?= site_url('index.php/social_auth/login/XXXXXX'); ?></code>
                    </p>
