...
<div class="ad ad-footer text-center"><?= htmlspecialchars_decode($Settings->ad_footer_code, ENT_QUOTES); ?></div>
<?php } ?>
...
<?php } ?>
<?php if ($footer_code) {
        echo htmlspecialchars_decode($footer_code, ENT_QUOTES);
    } ?>
</body>
</html>
